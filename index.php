...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <?php
                $sql3 = "select * from anime order by view desc limit 4";
                $result3 = executeResult($sql3);
                foreach($result3 as $data3)
                {?>
                <div class="hero__items bg-1 set-bg" data-setbg="<?=$data3['image']?>">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Adventure</div>
                                <h2><?=$data3['name']?></h2>
                                <p><?=$data3['other_name']?></p>
                                <a href="anime-details.php?id=<?=$data3['id']?>"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="<?=$data1['image']?>">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="anime-details.php?id=<?=$data1['id']?>">
                                                <?=$data1['name']?>
                                            </a></h5>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="product__sidebar">
                        <div class="product__sidebar__view">
                            ...
                            <?php
                                $sql2 = "SELECT * FROM anime order by view desc  ";
                                $result2 = executeResult($sql2);
                                foreach($result2 as $data2){?>
                            <div class="filter__gallery">
                                <div class="product__sidebar__view__item set-bg mix day years"
                                    data-setbg="<?=$data2['image']?>">
                                    <div class="ep">18 / ?</div>
                                    <div class="view"><i class="fa fa-eye"></i> 9141</div>
                                    <h5><a href="anime-details.php?id=<?=$data2['id']?>"><?=$data2['name']?></a></h5>
                                </div>
